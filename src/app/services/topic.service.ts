...
export class TopicService{
    ...
    prueba(){
        return "Hola mundo desde el topic service metodo prueba";
    }
    ...
    getTopics(page =1):Observable<any>{ //le paso la página, si no le paso nada asume 1, devuelve observable
